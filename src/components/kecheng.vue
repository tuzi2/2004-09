<template>
    <el-container>
      <el-main>
          ...
          <p class="pp">共<span> 4 </span>条数据</p>
          <!-- Form -->
                <el-dialog title="增加课程" :visible.sync="dialogFormVisible">
                  <el-form :model="form">
                    ...
                    <el-form-item label="收费模式:">
                      <el-radio v-model="radio" label="1">按课时收费</el-radio>
                      <el-radio v-model="radio" label="2">按期收费</el-radio>
                    </el-form-item>
                    <el-form-item label="单价:" class="form-items">
                      <el-input v-model="form.keshi" autocomplete="off" class="inputs"></el-input><span class="inputs-a">元/课时</span>
                    </el-form-item>
                    <el-form-item label="上课模式:">
                      <el-radio v-model="radios" label="1">一对一</el-radio>
                      <el-radio v-model="radios" label="2">集体班</el-radio>
                    </el-form-item>
                  </el-form>
